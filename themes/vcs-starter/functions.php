...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
        ...
        wp_deregister_script('jquery');
				wp_register_script('jquery', ASSETS_URL . '/assets/jquery-3.2.1.min.js', false, '2.1.1', true);

        wp_register_script('js_main', ASSETS_URL . '/assets/indexiukas.js', array(), '1.0', true);
...
function theme_stylesheets(){
	...
	$styles_path = ASSETS_URL . '/assets/indexiukas2.css';

	if( $styles_path ) {
	
		wp_register_style('style', ASSETS_URL . '/assets/indexiukas2.css', array(),false, false, 'all');
